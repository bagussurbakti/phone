   <!--main content end-->
      ...
      <footer class="site-footer">
          <div class="text-center">
              <?php echo date('Y');?> - Sistem Penjualan Barang Berbasis Web | PoltanganPhonen
              By <a href="https://www.instagram.com/" style="color:yellow;font-weight:700;" target="_blank">Fauzi Ahmad (Instagram)</a>
              <a href="#" class="go-top">
